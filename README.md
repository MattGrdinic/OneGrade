...
- **Analyze Frame** — measures and reports, changes nothing.
- **Auto Grade** — measures, then writes the look and the two derived values.
...
- **Show analysis** — reveals the numbers behind it all. Off by default.
